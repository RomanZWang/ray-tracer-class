...
public abstract class Surface {
     ...
     *
     * @param inBox  the bounding box to be grown
     */
     ...
     *
     * @param outCenter  center of surface for output
     */
     ...
     *
     * @param p     a point where the emitted ray pointing to
     * @param seed  seed used to generate a random point on the surface
     * @param lRec  the output information about the illumination 
     ...
     * 
     * @param p    a point where the emitted ray pointing to
     * @param lRec information about the illumination
     * @return     1 / area   
     */
    ...
    private static class SurfaceComparator implements Comparator<Surface> {
         ...
         * @param inAxis the axis of the comparator
         */
