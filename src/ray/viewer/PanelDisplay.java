...
public class PanelDisplay extends JPanel {
	 ...
	 *
	 * @param inFilename a representation of file and directory pathnames.
	 ...
	 * @param xl the lowest pixel index along x axis
	 * @param yl the lowest pixel index along y axis
	 * @param xh the highest pixel index along x axis
	 * @param yh the highest pixel index along y axis
	 */
