...
public class AxisAlignedBoundingBox {
   ...
   * @param inBox the bounding box to be included to the current bounding box
   */
   ...
   *
   * @param p the point to be added into this box
   */
   ...
   * @param x coordinate x to be included in the bounding box
   * @param y coordinate y to be included in the bounding box
   * @param z coordinate z to be included in the bounding box
   */
   ...
   * @param box the box assigned to the current box
   */
